...
val Emoji1f1e81f1f5: ImageVector
    get() {
        val current = _emoji1f1e81f1f5
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1e81f1f5",
            ...
            path(
                fill = SolidColor(Color(0xFF002495)),
            ) {
                // M 4 5
        ...
        }.build().also { _emoji1f1e81f1f5 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1e81f1f5: ImageVector? = null
