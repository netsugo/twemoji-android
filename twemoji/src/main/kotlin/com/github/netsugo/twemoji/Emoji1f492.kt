...
val Emoji1f492: ImageVector
    get() {
        val current = _emoji1f492
        ...
        return ImageVector.Builder(
            ...
            // M1 6 c0 -2.761 3.963 -4 5 0 1.121 -4 5 -2.761 5 0 0 3 -5 6 -5 6 S1 9 1 6z M25 6 c0 -2.761 3.963 -4 5 0 1.121 -4 5 -2.761 5 0 0 3 -5 6 -5 6 s-5 -3 -5 -6z
            path(
                fill = SolidColor(Color(0xFFDD2E44)),
            ) {
                // M 1 6
                moveTo(x = 1.0f, y = 6.0f)
                // c 0 -2.761 3.963 -4 5 0
                curveToRelative(
                    dx1 = 0.0f,
                    dy1 = -2.761f,
                    dx2 = 3.963f,
        ...
        }.build().also { _emoji1f492 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f492: ImageVector? = null
