...
val Emoji1f1e61f1f2: ImageVector
    get() {
        val current = _emoji1f1e61f1f2
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1e61f1f2",
            ...
            path(
                fill = SolidColor(Color(0xFFD90012)),
            ) {
                // M 32 5
            ...
            path(
                fill = SolidColor(Color(0xFFF2A800)),
            ) {
                // M 4 31
            ...
            // M0 13 h36 v10 H0z
            path(
                fill = SolidColor(Color(0xFF0033A0)),
            ) {
                // M 0 13
        ...
        }.build().also { _emoji1f1e61f1f2 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1e61f1f2: ImageVector? = null
