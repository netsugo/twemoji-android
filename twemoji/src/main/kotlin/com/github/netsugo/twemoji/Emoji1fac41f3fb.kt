...
val Emoji1fac41f3fb: ImageVector
    get() {
        val current = _emoji1fac41f3fb
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac41f3fb",
        ...
        }.build().also { _emoji1fac41f3fb = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac41f3fb: ImageVector? = null
