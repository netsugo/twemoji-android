...
val Emoji1f55b: ImageVector
    get() {
        val current = _emoji1f55b
        ...
        return ImageVector.Builder(
            ...
            // M18 19 c-0.552 0 -1 -0.447 -1 -1 V9 c0 -0.552 0.448 -1 1 -1 0.553 0 1 0.448 1 1 v9 c0 0.553 -0.447 1 -1 1z
            path(
                fill = SolidColor(Color(0xFF67757F)),
            ) {
                // M 18 19
        ...
        }.build().also { _emoji1f55b = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f55b: ImageVector? = null
