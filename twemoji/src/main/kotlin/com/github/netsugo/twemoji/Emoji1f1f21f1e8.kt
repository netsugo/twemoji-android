...
val Emoji1f1f21f1e8: ImageVector
    get() {
        val current = _emoji1f1f21f1e8
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f21f1e8",
        ...
        }.build().also { _emoji1f1f21f1e8 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f21f1e8: ImageVector? = null
