...
val Emoji2757: ImageVector
    get() {
        val current = _emoji2757
        ...
        return ImageVector.Builder(
            ...
            // M21 24 c0 1.657 -1.344 3 -3 3 -1.657 0 -3 -1.343 -3 -3 V5 c0 -1.657 1.343 -3 3 -3 1.656 0 3 1.343 3 3 v19z
            path(
                fill = SolidColor(Color(0xFFBE1931)),
            ) {
                // M 21 24
        ...
        }.build().also { _emoji2757 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji2757: ImageVector? = null
