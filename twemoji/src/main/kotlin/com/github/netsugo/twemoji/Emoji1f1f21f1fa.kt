...
val Emoji1f1f21f1fa: ImageVector
    get() {
        val current = _emoji1f1f21f1fa
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f21f1fa",
            ...
            // M0 11.5 h36 V18 H0z
            path(
                fill = SolidColor(Color(0xFF1A206D)),
            ) {
                // M 0 11.5
            ...
            path(
                fill = SolidColor(Color(0xFF00A551)),
            ) {
                // M 0 24.5
        ...
        }.build().also { _emoji1f1f21f1fa = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f21f1fa: ImageVector? = null
