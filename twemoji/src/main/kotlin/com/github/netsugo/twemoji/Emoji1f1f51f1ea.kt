...
val Emoji1f1f51f1ea: ImageVector
    get() {
        val current = _emoji1f1f51f1ea
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f51f1ea",
            ...
            path(
                fill = SolidColor(Color(0xFFD91023)),
            ) {
                // M 4 5
        ...
        }.build().also { _emoji1f1f51f1ea = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f51f1ea: ImageVector? = null
