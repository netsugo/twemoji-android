...
val Emoji1f1f01f1fc: ImageVector
    get() {
        val current = _emoji1f1f01f1fc
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f01f1fc",
            ...
            // M1.205 6.138 C0.462 6.865 0 7.879 0 9 v18 c0 1.122 0.462 2.135 1.205 2.862 L9 22.5 v-9 L1.205 6.138z
            path(
                fill = SolidColor(Color(0xFF141414)),
            ) {
                // M 1.205 6.138
                moveTo(x = 1.205f, y = 6.138f)
                // C 0.462 6.865 0 7.879 0 9
                curveTo(
                    x1 = 0.462f,
                    y1 = 6.865f,
                    x2 = 0.0f,
                ...
                // c 0 1.122 0.462 2.135 1.205 2.862
                curveToRelative(
                    dx1 = 0.0f,
                    dy1 = 1.122f,
                    dx2 = 0.462f,
                ...
                // L 9 22.5
                lineTo(x = 9.0f, y = 22.5f)
                // v -9
                verticalLineToRelative(dy = -9.0f)
                // L 1.205 6.138z
                lineTo(x = 1.205f, y = 6.138f)
                close()
            }
        }.build().also { _emoji1f1f01f1fc = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f01f1fc: ImageVector? = null
