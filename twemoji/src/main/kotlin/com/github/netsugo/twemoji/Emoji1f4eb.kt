...
val Emoji1f4eb: ImageVector
    get() {
        val current = _emoji1f4eb
        ...
        return ImageVector.Builder(
            ...
            // M9 3 c-3.866 0 -7 3.582 -7 8 v12 h14 V11 c0 -4.418 -3.134 -8 -7 -8z
            path(
                fill = SolidColor(Color(0xFF99AAB5)),
            ) {
                // M 9 3
                moveTo(x = 9.0f, y = 3.0f)
                // c -3.866 0 -7 3.582 -7 8
                curveToRelative(
                    dx1 = -3.866f,
                    dy1 = 0.0f,
                    dx2 = -7.0f,
            ...
            // M26 1 h-4 c-1.104 0 -2 0.896 -2 2 v12 c0 1.104 0.896 2 2 2 s2 -0.896 2 -2 V7 h2 c1.104 0 2 -0.896 2 -2 V3 c0 -1.104 -0.896 -2 -2 -2z
            path(
                fill = SolidColor(Color(0xFFDD2E44)),
            ) {
                // M 26 1
                moveTo(x = 26.0f, y = 1.0f)
                // h -4
        ...
        }.build().also { _emoji1f4eb = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f4eb: ImageVector? = null
