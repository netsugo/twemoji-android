...
val Emoji1f1ee1f1e9: ImageVector
    get() {
        val current = _emoji1f1ee1f1e9
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1ee1f1e9",
            ...
            path(
                fill = SolidColor(Color(0xFFDC1F26)),
            ) {
                // M 32 5
        ...
        }.build().also { _emoji1f1ee1f1e9 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1ee1f1e9: ImageVector? = null
