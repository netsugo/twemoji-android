...
val Emoji1f1f21f1eb: ImageVector
    get() {
        val current = _emoji1f1f21f1eb
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f21f1eb",
        ...
        }.build().also { _emoji1f1f21f1eb = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f21f1eb: ImageVector? = null
