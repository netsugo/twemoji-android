...
val Emoji1f1f21f1f1: ImageVector
    get() {
        val current = _emoji1f1f21f1f1
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f21f1f1",
            ...
            path(
                fill = SolidColor(Color(0xFF14B53A)),
            ) {
                // M 4 5
        ...
        }.build().also { _emoji1f1f21f1f1 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f21f1f1: ImageVector? = null
