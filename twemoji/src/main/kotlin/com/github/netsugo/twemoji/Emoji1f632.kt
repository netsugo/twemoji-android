...
val Emoji1f632: ImageVector
    get() {
        val current = _emoji1f632
        ...
        return ImageVector.Builder(
            ...
            // M18 23 c-1.657 0 -3 1.79 -3 4 h6 c0 -2.21 -1.343 -4 -3 -4z
            path(
                fill = SolidColor(Color(0xFFF5F8FA)),
            ) {
                // M 18 23
                moveTo(x = 18.0f, y = 23.0f)
                // c -1.657 0 -3 1.79 -3 4
                curveToRelative(
                    dx1 = -1.657f,
                    dy1 = 0.0f,
                    dx2 = -3.0f,
        ...
        }.build().also { _emoji1f632 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f632: ImageVector? = null
