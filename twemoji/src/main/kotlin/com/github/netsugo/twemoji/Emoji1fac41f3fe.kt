...
val Emoji1fac41f3fe: ImageVector
    get() {
        val current = _emoji1fac41f3fe
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac41f3fe",
        ...
        }.build().also { _emoji1fac41f3fe = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac41f3fe: ImageVector? = null
