...
val Emoji1f1e81f1ee: ImageVector
    get() {
        val current = _emoji1f1e81f1ee
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1e81f1ee",
            ...
            path(
                fill = SolidColor(Color(0xFFF77F00)),
            ) {
                // M 4 5
        ...
        }.build().also { _emoji1f1e81f1ee = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1e81f1ee: ImageVector? = null
