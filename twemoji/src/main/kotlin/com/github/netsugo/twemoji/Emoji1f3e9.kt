...
val Emoji1f3e9: ImageVector
    get() {
        val current = _emoji1f3e9
        ...
        return ImageVector.Builder(
            ...
            path(
                fill = SolidColor(Color(0xFFFFD4DE)),
            ) {
                // M 16 5
            ...
            // M10 14 v4 H6 v-4 H4 v10 h2 v-4 h4 v4 h2 V14z
            path(
            ...
            // M3 3 C3 0.239 6.963 -1 8 3 c1.122 -4 5 -2.761 5 0 0 3 -5 6 -5 6 S3 6 3 3z
            path(
                fill = SolidColor(Color(0xFFEA596E)),
            ) {
                // M 3 3
                moveTo(x = 3.0f, y = 3.0f)
                // C 3 0.239 6.963 -1 8 3
                curveTo(
                    x1 = 3.0f,
                    y1 = 0.239f,
                    x2 = 6.963f,
        ...
        }.build().also { _emoji1f3e9 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f3e9: ImageVector? = null
