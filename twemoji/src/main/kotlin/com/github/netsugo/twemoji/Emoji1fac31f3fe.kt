...
val Emoji1fac31f3fe: ImageVector
    get() {
        val current = _emoji1fac31f3fe
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac31f3fe",
            ...
            // m24.999 27.362  l-0.001 1.309 -3.94 2.674 -2.641 -4.139 5.645 -5.81 -1.939 -1.923 0.501 -0.751 2.834 2.833 -6.054 5.89 2.222 2.222 s1.582 -1.066 3.373 -2.305z M17 22.582 v-0.928 a8.357 8.357 0 0 0 -1.442 0.232 l0.44 -4.841 -0.996 -0.091 -0.478 5.262 c-3.098 1.218 -5.294 4.225 -5.294 7.755 0 2.372 0.994 4.508 2.584 6.028 h1.449 a7.405 7.405 0 0 1 -3.105 -6.028 c0 -3.902 3.015 -7.094 6.842 -7.389z
            path(
                fill = SolidColor(Color(0xFF5B9239)),
            ) {
                // M 24.999 27.362
                ...
                close()
                // M 17 22.582
                moveTo(x = 17.0f, y = 22.582f)
                // v -0.928
                verticalLineToRelative(dy = -0.928f)
                // a 8.357 8.357 0 0 0 -1.442 0.232
                arcToRelative(
                    a = 8.357f,
                    b = 8.357f,
                    theta = 0.0f,
                ...
                // l 0.44 -4.841
                lineToRelative(dx = 0.44f, dy = -4.841f)
                // l -0.996 -0.091
                lineToRelative(dx = -0.996f, dy = -0.091f)
                // l -0.478 5.262
                lineToRelative(dx = -0.478f, dy = 5.262f)
                // c -3.098 1.218 -5.294 4.225 -5.294 7.755
                curveToRelative(
                    dx1 = -3.098f,
                    dy1 = 1.218f,
                    dx2 = -5.294f,
                ...
                // c 0 -3.902 3.015 -7.094 6.842 -7.389z
                curveToRelative(
                    dx1 = 0.0f,
                    dy1 = -3.902f,
                    dx2 = 3.015f,
            ...
            // M20.927 1.747 C18.323 0.301 15.458 0.154 12.312 2.87 c-1.281 1.106 -2.068 1.049 -2.206 1.373 -0.527 1.964 1.81 3.868 2.267 3.317 1.446 -1.744 3.265 -1.84 3.998 -1.154 0.706 0.677 0.852 2.248 1.184 2.122 0.9 -0.341 0.415 -1.206 0.573 -1.883 0.245 -1.115 1.318 -0.978 1.866 -0.089 0.434 0.704 0.726 2.081 -0.36 2.798 1.146 1.606 2.453 1.527 2.453 1.527 s0.493 0.001 1.188 -2.249 0.021 -5.53 -2.348 -6.885z
            path(
                fill = SolidColor(Color(0xFF60352A)),
            ) {
                // M 20.927 1.747
                moveTo(x = 20.927f, y = 1.747f)
                // C 18.323 0.301 15.458 0.154 12.312 2.87
                curveTo(
                    x1 = 18.323f,
                    y1 = 0.301f,
                    x2 = 15.458f,
                ...
                // c -1.281 1.106 -2.068 1.049 -2.206 1.373
                curveToRelative(
                    dx1 = -1.281f,
                    dy1 = 1.106f,
                    dx2 = -2.068f,
                ...
                // c -0.527 1.964 1.81 3.868 2.267 3.317
                curveToRelative(
                    dx1 = -0.527f,
                    dy1 = 1.964f,
                    dx2 = 1.81f,
                ...
                // c 1.446 -1.744 3.265 -1.84 3.998 -1.154
                curveToRelative(
                    dx1 = 1.446f,
                    dy1 = -1.744f,
                    dx2 = 3.265f,
                ...
                // c 0.706 0.677 0.852 2.248 1.184 2.122
                curveToRelative(
                    dx1 = 0.706f,
                    dy1 = 0.677f,
                    dx2 = 0.852f,
                ...
                // c 0.9 -0.341 0.415 -1.206 0.573 -1.883
                curveToRelative(
                    dx1 = 0.9f,
                    dy1 = -0.341f,
                    dx2 = 0.415f,
                ...
                // c 0.245 -1.115 1.318 -0.978 1.866 -0.089
                curveToRelative(
                    dx1 = 0.245f,
                    dy1 = -1.115f,
                    dx2 = 1.318f,
                ...
                // c 0.434 0.704 0.726 2.081 -0.36 2.798
                curveToRelative(
                    dx1 = 0.434f,
                    dy1 = 0.704f,
                    dx2 = 0.726f,
                ...
                // c 1.146 1.606 2.453 1.527 2.453 1.527
                curveToRelative(
                    dx1 = 1.146f,
                    dy1 = 1.606f,
                    dx2 = 2.453f,
        ...
        }.build().also { _emoji1fac31f3fe = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac31f3fe: ImageVector? = null
