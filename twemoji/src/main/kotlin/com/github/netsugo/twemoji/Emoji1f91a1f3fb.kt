...
val Emoji1f91a1f3fb: ImageVector
    get() {
        val current = _emoji1f91a1f3fb
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f91a1f3fb",
        ...
        }.build().also { _emoji1f91a1f3fb = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f91a1f3fb: ImageVector? = null
