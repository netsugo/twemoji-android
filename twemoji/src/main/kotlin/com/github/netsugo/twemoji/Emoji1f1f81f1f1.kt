...
val Emoji1f1f81f1f1: ImageVector
    get() {
        val current = _emoji1f1f81f1f1
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f81f1f1",
        ...
        }.build().also { _emoji1f1f81f1f1 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f81f1f1: ImageVector? = null
