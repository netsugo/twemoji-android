...
val Emoji1f1f31f1ea: ImageVector
    get() {
        val current = _emoji1f1f31f1ea
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f31f1ea",
            ...
            path(
                fill = SolidColor(Color(0xFFE05206)),
            ) {
                // M 32 5
            ...
            // M32 31 H4 c-2.209 0 -4 -1.791 -4 -4 v-4 h36 v4 c0 2.209 -1.791 4 -4 4z
            path(
                fill = SolidColor(Color(0xFF0DB02B)),
            ) {
                // M 32 31
        ...
        }.build().also { _emoji1f1f31f1ea = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f31f1ea: ImageVector? = null
