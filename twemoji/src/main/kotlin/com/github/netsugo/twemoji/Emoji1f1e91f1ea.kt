...
val Emoji1f1e91f1ea: ImageVector
    get() {
        val current = _emoji1f1e91f1ea
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1e91f1ea",
            ...
            path(
                fill = SolidColor(Color(0xFFFFCD05)),
            ) {
                // M 0 27
            ...
            // M0 14 h36 v9 H0z
            path(
                fill = SolidColor(Color(0xFFED1F24)),
            ) {
                // M 0 14
        ...
        }.build().also { _emoji1f1e91f1ea = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1e91f1ea: ImageVector? = null
