...
val Emoji1fac41f3fc: ImageVector
    get() {
        val current = _emoji1fac41f3fc
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac41f3fc",
        ...
        }.build().also { _emoji1fac41f3fc = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac41f3fc: ImageVector? = null
