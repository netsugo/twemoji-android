...
val Emoji1f1ea1f1ea: ImageVector
    get() {
        val current = _emoji1f1ea1f1ea
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1ea1f1ea",
            ...
            path(
                fill = SolidColor(Color(0xFF4891D9)),
            ) {
                // M 32 5
        ...
        }.build().also { _emoji1f1ea1f1ea = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1ea1f1ea: ImageVector? = null
