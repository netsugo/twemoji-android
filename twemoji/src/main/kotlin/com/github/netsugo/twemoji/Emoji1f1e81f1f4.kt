...
val Emoji1f1e81f1f4: ImageVector
    get() {
        val current = _emoji1f1e81f1f4
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1e81f1f4",
            ...
            // M0 27 c0 2.209 1.791 4 4 4 h28 c2.209 0 4 -1.791 4 -4 v-2 H0 v2z
            path(
        ...
        }.build().also { _emoji1f1e81f1f4 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1e81f1f4: ImageVector? = null
