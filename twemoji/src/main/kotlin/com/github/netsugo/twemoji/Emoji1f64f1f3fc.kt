...
val Emoji1f64f1f3fc: ImageVector
    get() {
        val current = _emoji1f64f1f3fc
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f64f1f3fc",
            ...
            // M18 25.823 c-0.414 0 -0.75 -0.336 -0.75 -0.75 V2.792 c0 -0.414 0.336 -0.75 0.75 -0.75 s0.75 0.336 0.75 0.75 v22.281 c0 0.414 -0.336 0.75 -0.75 0.75z
            path(
                fill = SolidColor(Color(0xFFE2C196)),
            ) {
                // M 18 25.823
                moveTo(x = 18.0f, y = 25.823f)
                ...
                // v 22.281
                verticalLineToRelative(dy = 22.281f)
        ...
        }.build().also { _emoji1f64f1f3fc = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f64f1f3fc: ImageVector? = null
