...
val Emoji1f64f1f3fe: ImageVector
    get() {
        val current = _emoji1f64f1f3fe
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f64f1f3fe",
        ...
        }.build().also { _emoji1f64f1f3fe = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f64f1f3fe: ImageVector? = null
