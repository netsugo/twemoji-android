...
val Emoji1f1eb1f1f7: ImageVector
    get() {
        val current = _emoji1f1eb1f1f7
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1eb1f1f7",
        ...
        }.build().also { _emoji1f1eb1f1f7 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1eb1f1f7: ImageVector? = null
