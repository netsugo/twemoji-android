...
val Emoji1f620: ImageVector
    get() {
        val current = _emoji1f620
        ...
        return ImageVector.Builder(
            ...
            // M25.485 29.879 C25.44 29.7 24.317 25.5 18 25.5 c-6.318 0 -7.44 4.2 -7.485 4.379 -0.055 0.217 0.043 0.442 0.237 0.554 0.195 0.109 0.439 0.079 0.6 -0.077 0.019 -0.019 1.954 -1.856 6.648 -1.856 s6.63 1.837 6.648 1.855 c0.096 0.095 0.224 0.145 0.352 0.145 0.084 0 0.169 -0.021 0.246 -0.064 0.196 -0.112 0.294 -0.339 0.239 -0.557z M15.707 17.293 C12.452 14.038 7.221 14 7 14 c-0.552 0 -0.999 0.447 -0.999 0.998 -0.001 0.552 0.446 1 0.998 1.002 0.029 0 1.925 0.022 3.983 0.737 -0.593 0.64 -0.982 1.634 -0.982 2.763 0 1.934 1.119 3.5 2.5 3.5 s2.5 -1.566 2.5 -3.5 c0 -0.174 -0.019 -0.34 -0.037 -0.507 0.013 0 0.025 0.007 0.037 0.007 0.256 0 0.512 -0.098 0.707 -0.293 0.391 -0.391 0.391 -1.023 0 -1.414z M29 14 c-0.221 0 -5.451 0.038 -8.707 3.293 -0.391 0.391 -0.391 1.023 0 1.414 0.195 0.195 0.451 0.293 0.707 0.293 0.013 0 0.024 -0.007 0.036 -0.007 -0.016 0.167 -0.036 0.333 -0.036 0.507 0 1.934 1.119 3.5 2.5 3.5 s2.5 -1.566 2.5 -3.5 c0 -1.129 -0.389 -2.123 -0.982 -2.763 2.058 -0.715 3.954 -0.737 3.984 -0.737 0.551 -0.002 0.998 -0.45 0.997 -1.002 -0.001 -0.551 -0.447 -0.998 -0.999 -0.998z
            path(
                ...
                close()
                // M 15.707 17.293
                moveTo(x = 15.707f, y = 17.293f)
                // C 12.452 14.038 7.221 14 7 14
                curveTo(
                    x1 = 12.452f,
                    y1 = 14.038f,
                    x2 = 7.221f,
        ...
        }.build().also { _emoji1f620 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f620: ImageVector? = null
