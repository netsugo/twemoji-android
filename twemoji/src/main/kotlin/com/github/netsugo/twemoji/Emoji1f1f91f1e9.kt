...
val Emoji1f1f91f1e9: ImageVector
    get() {
        val current = _emoji1f1f91f1e9
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f91f1e9",
            ...
            path(
                fill = SolidColor(Color(0xFF002664)),
            ) {
                // M 4 5
            ...
            // M12 5 h12 v26 H12z
            path(
                fill = SolidColor(Color(0xFFFECB00)),
            ) {
                // M 12 5
        ...
        }.build().also { _emoji1f1f91f1e9 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f91f1e9: ImageVector? = null
