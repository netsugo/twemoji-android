...
val Emoji1f1f31f1f1: ImageVector
    get() {
        val current = _emoji1f1f31f1f1
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f31f1f1",
            ...
            path(
                fill = SolidColor(Color(0xFFAE1F28)),
            ) {
                // M 32 5
            ...
            path(
                fill = SolidColor(Color(0xFF20478B)),
            ) {
                // M 4 31
        ...
        }.build().also { _emoji1f1f31f1f1 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f31f1f1: ImageVector? = null
