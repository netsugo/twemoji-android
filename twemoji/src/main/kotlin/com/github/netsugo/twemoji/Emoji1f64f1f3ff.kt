...
val Emoji1f64f1f3ff: ImageVector
    get() {
        val current = _emoji1f64f1f3ff
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f64f1f3ff",
        ...
        }.build().also { _emoji1f64f1f3ff = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f64f1f3ff: ImageVector? = null
