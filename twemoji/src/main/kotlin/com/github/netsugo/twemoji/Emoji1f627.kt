...
val Emoji1f627: ImageVector
    get() {
        val current = _emoji1f627
        ...
        return ImageVector.Builder(
            ...
            // M5.999 12 c-0.208 0 -0.419 -0.065 -0.599 -0.2 -0.442 -0.331 -0.531 -0.958 -0.2 -1.4 C8.462 6.05 12.816 6 13 6 c0.552 0 1 0.448 1 1 0 0.551 -0.445 0.998 -0.996 1 -0.155 0.002 -3.568 0.086 -6.204 3.6 -0.196 0.262 -0.497 0.4 -0.801 0.4z M30.001 12 c-0.305 0 -0.604 -0.138 -0.801 -0.4 -2.64 -3.521 -6.061 -3.598 -6.206 -3.6 -0.55 -0.006 -0.994 -0.456 -0.991 -1.005 C22.006 6.444 22.45 6 23 6 c0.184 0 4.537 0.05 7.8 4.4 0.332 0.442 0.242 1.069 -0.2 1.4 -0.18 0.135 -0.39 0.2 -0.599 0.2z M23.485 27.879 C23.474 27.835 22.34 23.5 18 23.5 s-5.474 4.335 -5.485 4.379 c-0.053 0.213 0.044 0.431 0.232 0.544 0.188 0.112 0.433 0.086 0.596 -0.06 0.009 -0.008 1.013 -0.863 4.657 -0.863 3.59 0 4.617 0.83 4.656 0.863 0.095 0.09 0.219 0.137 0.344 0.137 0.084 0 0.169 -0.021 0.246 -0.064 0.196 -0.112 0.294 -0.339 0.239 -0.557z
            path(
                fill = SolidColor(Color(0xFF664500)),
            ) {
                // M 5.999 12
                moveTo(x = 5.999f, y = 12.0f)
        ...
        }.build().also { _emoji1f627 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f627: ImageVector? = null
