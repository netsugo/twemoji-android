...
val Emoji1f1ec1f1e6: ImageVector
    get() {
        val current = _emoji1f1ec1f1e6
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1ec1f1e6",
            ...
            path(
                fill = SolidColor(Color(0xFF3A75C4)),
            ) {
                // M 0 27
        ...
        }.build().also { _emoji1f1ec1f1e6 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1ec1f1e6: ImageVector? = null
