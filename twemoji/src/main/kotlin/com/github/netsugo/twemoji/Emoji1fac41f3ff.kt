...
val Emoji1fac41f3ff: ImageVector
    get() {
        val current = _emoji1fac41f3ff
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac41f3ff",
        ...
        }.build().also { _emoji1fac41f3ff = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac41f3ff: ImageVector? = null
