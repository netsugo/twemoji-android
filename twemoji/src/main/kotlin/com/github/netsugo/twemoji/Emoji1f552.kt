...
val Emoji1f552: ImageVector
    get() {
        val current = _emoji1f552
        ...
        return ImageVector.Builder(
            ...
            // M28 18 c0 0.552 -0.447 1 -1 1 h-9 c-0.552 0 -1 -0.448 -1 -1 s0.448 -1 1 -1 h9 c0.553 0 1 0.448 1 1z
            path(
                fill = SolidColor(Color(0xFF66757F)),
            ) {
                // M 28 18
        ...
        }.build().also { _emoji1f552 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f552: ImageVector? = null
