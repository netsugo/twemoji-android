...
val Emoji1f1f11f1fa: ImageVector
    get() {
        val current = _emoji1f1f11f1fa
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f11f1fa",
            ...
            path(
                fill = SolidColor(Color(0xFF00A1DE)),
            ) {
                // M 4 31
        ...
        }.build().also { _emoji1f1f11f1fa = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f11f1fa: ImageVector? = null
