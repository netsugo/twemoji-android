...
val Emoji1f1f81f1e9: ImageVector
    get() {
        val current = _emoji1f1f81f1e9
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f81f1e9",
        ...
        }.build().also { _emoji1f1f81f1e9 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f81f1e9: ImageVector? = null
