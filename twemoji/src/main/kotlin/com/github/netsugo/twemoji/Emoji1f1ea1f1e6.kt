...
val Emoji1f1ea1f1e6: ImageVector
    get() {
        val current = _emoji1f1ea1f1e6
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1ea1f1e6",
        ...
        }.build().also { _emoji1f1ea1f1e6 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1ea1f1e6: ImageVector? = null
