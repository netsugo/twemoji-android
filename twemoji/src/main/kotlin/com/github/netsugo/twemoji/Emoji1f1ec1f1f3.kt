...
val Emoji1f1ec1f1f3: ImageVector
    get() {
        val current = _emoji1f1ec1f1f3
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1ec1f1f3",
            ...
            path(
                fill = SolidColor(Color(0xFF009460)),
            ) {
                // M 32 5
        ...
        }.build().also { _emoji1f1ec1f1f3 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1ec1f1f3: ImageVector? = null
