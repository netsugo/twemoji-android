...
val Emoji1fac31f3ff: ImageVector
    get() {
        val current = _emoji1fac31f3ff
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac31f3ff",
        ...
        }.build().also { _emoji1fac31f3ff = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac31f3ff: ImageVector? = null
