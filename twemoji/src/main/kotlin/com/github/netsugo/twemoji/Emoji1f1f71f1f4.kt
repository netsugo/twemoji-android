...
val Emoji1f1f71f1f4: ImageVector
    get() {
        val current = _emoji1f1f71f1f4
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f71f1f4",
        ...
        }.build().also { _emoji1f1f71f1f4 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f71f1f4: ImageVector? = null
