...
val Emoji1f64f1f3fd: ImageVector
    get() {
        val current = _emoji1f64f1f3fd
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f64f1f3fd",
        ...
        }.build().also { _emoji1f64f1f3fd = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f64f1f3fd: ImageVector? = null
