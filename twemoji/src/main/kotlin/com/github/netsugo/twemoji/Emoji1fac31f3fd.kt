...
val Emoji1fac31f3fd: ImageVector
    get() {
        val current = _emoji1fac31f3fd
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac31f3fd",
        ...
        }.build().also { _emoji1fac31f3fd = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac31f3fd: ImageVector? = null
