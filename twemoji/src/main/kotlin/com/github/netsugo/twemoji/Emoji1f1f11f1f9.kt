...
val Emoji1f1f11f1f9: ImageVector
    get() {
        val current = _emoji1f1f11f1f9
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1f1f11f1f9",
            ...
            // M0 14 h36 v8 H0z
            path(
                fill = SolidColor(Color(0xFF006A44)),
            ) {
                // M 0 14
            ...
            path(
                fill = SolidColor(Color(0xFFFDB913)),
            ) {
                // M 32 5
            ...
            path(
                fill = SolidColor(Color(0xFFC1272D)),
            ) {
                // M 4 31
        ...
        }.build().also { _emoji1f1f11f1f9 = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1f1f11f1f9: ImageVector? = null
