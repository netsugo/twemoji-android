...
val Emoji1fac31f3fc: ImageVector
    get() {
        val current = _emoji1fac31f3fc
        if (current != null) return current

        return ImageVector.Builder(
            name = ".Emoji1fac31f3fc",
        ...
        }.build().also { _emoji1fac31f3fc = it }
    }

@Suppress("ObjectPropertyName")
private var _emoji1fac31f3fc: ImageVector? = null
